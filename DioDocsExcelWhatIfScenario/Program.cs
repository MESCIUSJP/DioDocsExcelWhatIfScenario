...
worksheet.Scenarios.Add("低値引き率", worksheet.Range["D2:D6"], lessDiscountRatesValues);

// 標準の値引き率のシナリオ
List<object> normalDiscountRatesValues = [0.1, 0.07, 0.07, 0.05, 0.05];
worksheet.Scenarios.Add("標準値引き率", worksheet.Range["D2:D6"], normalDiscountRatesValues);

// 割引なしで販売するシナリオ
List<object> sellingWithoutDiscountValues = [0, 0, 0, 0, 0];
worksheet.Scenarios.Add("割引なし", worksheet.Range["D2:D6"], sellingWithoutDiscountValues);
